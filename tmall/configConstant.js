var config = {
    ...
    "viewCfg": {
        "password": {
            "moduleCfg": {
                "blockCfg": {
                    "smsLoginTabItem": {
                        "className": "sms-login-tab-item",
                        "href": "javascript:void(0);",
                        "onClick": "function(){window.events.publish('changeView', 'sms');}",
                        "text": "短信登录",
                        "type": "link"
                    },
                    "weiboLoginLink": {
                        "className": "weibo-login",
                        "href": "http://weibo.com/login.php?entry=taobao&goto=https%3A%2F%2Flogin.taobao.com%2Faso%2Ftvs%3Fdomain%3Dweibo%26sid%3Dcf56b3baedd985d8e3186bdf205b64a6%26target%3D&goto2=",
                        "target": "_self",
                        "text": "<i class=\"iconfont\"></i>微博登录",
                        "type": "link"
                    },
                    "alipayLoginLink": {
                        "className": "alipay-login",
                        "href": "https://auth.alipay.com/login/index.htm?loginScene=7&goto=https%3A%2F%2Fauth.alipay.com%2Flogin%2Ftaobao_trust_login.htm%3Ftarget%3Dhttps%253A%252F%252Flogin.taobao.com%252Fmember%252Falipay_sign_dispatcher.jhtml&params=VFBMX3JlZGlyZWN0X3VybD0%3D",
                        "target": "_self",
                        "text": "<i class=\"iconfont\"></i>支付宝登录",
                        "type": "link"
                    },
                    "forgotUserNameLink": {
                        "className": "forgot-username-a-link",
                        "href": "https://passport.taobao.com/ac/nick_find.htm?from_site=0&lang=zh_CN&app_name=tb",
                        "text": "忘记用户名",
                        "type": "link"
                    },
                    "forgotPwdLink": {
                        "className": "forgot-password-a-link",
                        "href": "https://passport.taobao.com/ac/password_find.htm?from_site=0&lang=zh_CN&app_name=tb&tracelog=signin_main_pass",
                        "text": "忘记密码",
                        "type": "link"
                    },
                    "passwordLoginTabItem": {
                        "className": "password-login-tab-item",
                        "href": "javascript:void(0);",
                        "onClick": "function(){window.events.publish('changeView', 'password');}",
                        "text": "密码登录",
                        "type": "link"
                    },
                    "registerLink": {
                        "className": "register-a-link",
                        "href": "https://reg.taobao.com/member/newbie.htm?from=login",
                        "text": "免费注册",
                        "type": "link"
                    }
                },
                "blockClassMapping": {
                    "block00": "login-switch-tab",
                    "block8": "sns-login-links",
                    "block9": "login-links"
                },
                "blockLayout": {
                    "block00": ["passwordLoginTabItem", "smsLoginTabItem"],
                    "block8": ["weiboLoginLink", "alipayLoginLink", "facebookLoginButton"],
                    "block9": ["forgotPwdLink", "forgotUserNameLink", "registerLink"]
                }
            },
        ...
        "qrcode": {
            "moduleCfg": {
                ...
                "blockClassMapping": {
                    "block3": "qrcode-bottom-links"
                },
                "blockLayout": {
                    "block3": ["passwordLoginLink", "registerLink"]
                }
            },
            "size": 130,
            "useImgQrCode": false
        ...
        "sms": {
            "countryAreaSelectSelectStyle": "nativeStyleSimple",
            "moduleCfg": {
                "blockCfg": {
                    "smsLoginTabItem": {
                        "className": "sms-login-tab-item",
    ...
    "countryList": [{
        ...
        "areaName": "法国",
        "checkKey": "^(00){0,1}(33){1}(\\d{6}|\\d{8,9})$",
        "countryCode": "FR",
        "phoneCode": "33"
    }, {
        "areaName": "俄罗斯",
